...
namespace AdeptusMechanicus.ExtensionMethods
{
    public static class OrkPawnKindDefExtensions
    {
        ...
        {
            return pawn.race == AdeptusThingDefOf.OG_Alien_Ork || pawn.race.defName.Contains("Alien_Ork") || pawn.race.defName.Contains("Cybork");
        }

        public static bool isGrot(this PawnKindDef pawn)
        {
            return pawn.race == AdeptusThingDefOf.OG_Alien_Grot || pawn.race.defName.Contains("Alien_Grot");
        }
