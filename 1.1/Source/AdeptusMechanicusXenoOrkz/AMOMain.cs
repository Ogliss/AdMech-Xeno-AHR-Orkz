...
namespace AdeptusMechanicus
{
    ...
    public class AMOMain
    {
        ...
        static AMOMain()
        {
            AlienRace.ThingDef_AlienRace Ork = OrkThingDefOf.OG_Alien_Ork as AlienRace.ThingDef_AlienRace;
            AlienRace.ThingDef_AlienRace Grot = OrkThingDefOf.OG_Alien_Grot as AlienRace.ThingDef_AlienRace;
            ...
            List<ThingDef> races = new List<ThingDef>() { Ork, Grot, OrkThingDefOf.OG_Snotling};
