...
namespace AdeptusMechanicus.HarmonyInstance
{
    ...
    public static class Pawn_AgeTracker_TryChildGrowthMoment_Orkoid_Patch
    {
        /*
    ...
    [HarmonyPatch(typeof(GrowthUtility), "IsGrowthBirthday")]
    public static class GrowthUtility_IsGrowthBirthday_Orkoid_Patch
    {
        /*
    private static void Prefix(Pawn_AgeTracker __instance, Pawn ___pawn, ref float ___growth)
    {
